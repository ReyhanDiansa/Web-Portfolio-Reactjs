    ...
    <Box sx={{ display: "flex" }} className="about">
      ...
      <Box className="about-text">
        ...
        <Typography variant="p" component="div" className="about-text-info">
          ...
          showcasing my journey as a programmer and my projects. My passion for
          coding began at a young age, and it has only grown stronger over the
          years. I am fascinated by the limitless possibilities that coding
          offers, and I am always looking for new challenges and opportunities
          to improve my skills.
        </Typography>
        <Typography variant="p" component="div" className="about-text-info">
          I have learned various programming languages such as{" "}
          <span className="text-orange">Java, PHP, and Java Script</span>, and I
          have also been involved in various projects, both individually and in
          a team. My goal is to not only learn the fundamentals of programming
          but also to apply my knowledge to real-world problems and contribute
          to the growth of the technology industry. I believe that with my
